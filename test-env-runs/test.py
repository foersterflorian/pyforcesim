...
NORMALISE_OBS: Final[bool] = False
...
FILENAME_TARGET_MODEL: Final[str] = '2024-07-19--12-52-48_pyf_sim_PPO_mask_TS-92160'
...
def test() -> None:
    ...
    env = DummyVecEnv([lambda: make_env(ROOT_EXP_TYPE, None, True)])
